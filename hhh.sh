...
CUDA_VISIBLE_DEVICES=4 python train_boundary.py --tensorboard-path /home/ubuntu/TB18 --save-params-path /home/ubuntu/param,18 --epochs 200 --lr-epoch 180 --mixup-epoch 0 --data-dir /home/ubuntu/FaceDatasets/WFLW/WFLW_crop_annotations/resplit_0.0_1_sigma_3_64_train.txt --per-batch 32 --norm-type IN --pretrained 0  --loss-type 0 --use-compress 1
