...
def parse_args():
    ...
    parser.add_argument('--per-batch', type=int, default=28, help='Per card batch size')
    ...
    # 0.1 ok
    parser.add_argument('--lr-base', type=tuple, default=(1e-2, 2e-1, 1e-4), help='Learning Rate')
    parser.add_argument('--lr-target', type=tuple, default=(1e-5, 2e-5, 1e-10), help='Learning Rate')
    parser.add_argument('--lr-mode', type=str, default="cosine", help='Learning Rate')
    parser.add_argument('--beta', type=tuple, default=(0.9, 0.999), help='Adam beta tuple')
    ...
    parser.add_argument('--pretrained', type=int, default=11, help='')
